...
retnings-linjer hjemmelsgrunnlag}
...
\guide{Fyll inn resultater. Relativt uavhengig ift resten av dokumentet.}
...
kompletthet for sntrale variabler.}
...
kvalitet. Se også
\href{http://www.kvalitetsregistre.no/getfile.php/Norsk/Dokumenter/Handbok_120411_siste.pdf}{Registerhåndboka}\footnote{\url{http://www.kvalitetsregistre.no/getfile.php/Norsk/Dokumenter/Handbok_120411_siste.pdf}}
...
\guide{Dersom nasjonale retningslionjer finnes, beskriv om disse er inkludert
...
\begin{longtable}{rp{10cm}lcc}
  ...
  \endlastfoot 	 	 
   & \textbf{Stadium 2} & & \\
  1 & Er i drift og samler data nasjonalt & \ref{cha:res} & \Square & \Square \\
  ...
  nasjonale resultater & \ref{sec:resfag}, \ref{sec:off} & \Square & \Square \\
  ...
  praksis & \ref{sec:evakva} & \Square& \Square \\
  \label{tab:sta} 	 
\end{longtable}
