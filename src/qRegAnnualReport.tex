...
registeret formål, med hovedfokus på kvalitetsindikatorer og PROM/PREM.}
...
registeret har kommet for å inkludere slike variabler.Resultater i seg selv
...
i forbindelse med den behandling som registeret omfatter. Resultater presenteresog beskrives i kap. \ref{cha:res}.}
