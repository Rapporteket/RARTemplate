...
\chapter{\textcolor{red}{Metodisk kvalitet}\textcolor{blue}{Datakvalitet}}\label{cha:kva}
\guide{Status og evaluering av registerets  datakvalitet. Dekningsgraden angir
forholdet mellom registrerte \newtext{hendelser/}individer og det man basert på uavhengige kilder
(f.eks.
...
\newtext{hendelser/}individer i det aktuelle året. \oldtext{Validitet angir graden av korrekthet for
...
individer/hendelser \newtext{per institusjon og år, samt} totalt.}
...
valideringsstudien\newtext{, eksempelvis:
\begin{itemize}
  \item hvilke sykehus, avdelinger eller enheter som ble validert og
  hvordan/hvorfor disse ble valgt,
...
\begin{itemize}
  ...
  \item \newtext{Vis registreringsforsinkelse (aktualitet), det vil si tid fra
    ...
    (registreres egentlig det samme på alle avdelinger)
  \item \newtext{Gi en vurdering av sammenlignbarhet (registreres egentlig det 
    samme på alle avdelinger og over tid)  for
    ...
    variabelsettet}
    \item \newtext{Si noe om reliabiliteten, dvs. 'treffsikkerheten'/variasjonen ved gjentatte målinger}
\end{itemize}}
