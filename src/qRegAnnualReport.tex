...
\newcommand{\guide}[1]{
  \textit{[\textcolor{guidegray}{Veiledning -- SLETTES VED UTFYLLING: #1}]}}
...
diagnosegrupper) der dette er relevant. % must be a \par here
...
\begin{itemize}
  \item hvilke sykehus, avdelinger eller enheter som ble validert samt
  hvordan og hvorfor disse ble valgt,
