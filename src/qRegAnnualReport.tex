...
\begin{itemize}
  ...
  \item hvordan analysene er gjort (metode), og
...
\begin{itemize}
  \item resultat av dekningsgradsanalyse på individnivå for alle pasientgrupper
    samlet,
  \item tidspunkt for gjennomføring av dekningsgradsanalysen, og
...
for alle kvalitetsindikatorene, og evt. i tillegg noen av de mest sentrale
variablene:
\begin{enumerate}
