...
hendelser/individer i det aktuelle året. For sentrale variable bør kunne si noe om alle
dimensjoner ved datakvalitet:
\begin{itemize}
  \item kompletthet (dekningsgrad og ufullstendige registreringer)
  \item validitet (gyldighet/korrekthet av registreringa)
  \item sammenlignbarhet (registreres det samme på alle avdelinger)
...
totalt og tidspunkt for gjennomføring av dekningsgradsanalysen. Dekningsgrad oppgis 
for hele registerpopulasjonen på sykehus- eller enhetsnivå. Der dette er relevant, kan 
i tillegg dekningsgrad oppgis på gruppenivå (for eksempel
diagnosegrupper).
...
\begin{itemize}
  \item Angi viktige funn og en vurdering av resultatene fra alle dimensjoner
    av datakvalitet der dette er relevant og utført. 
    Et eksempel er funn av systematiske feil eller tilfeldige feil
  ...
  \item Gi en vurdering av sammenlignbarhet (registreres det  samme på
...
analyser fra registeret i årsrapportåret.}
...
registeret) i årsrapportåret. Beskriv hvordan registeret bidrar til
