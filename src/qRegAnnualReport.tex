...
\begin{longtable}{lrp{8cm}p{2.5cm}}
  ...
  \hline
    ...
    ekspertgruppen og servicemiljøet i Helse Vest & Are Edvardsen \\
  \label{tab:log}
\end{longtable}
\fi
...
\guide{Angi resultat av dekningsgradsanalyse på individnivå og tidspunkt for
gjennomføring av dekningsgradsanalysen.}
