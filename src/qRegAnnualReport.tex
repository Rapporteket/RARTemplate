...
hendelser/individer i det aktuelle året. }
...
\guide{Angi viktige funn og en vurdering av resultatene fra valideringsanalyser slik som funn av systematisk feil, tilfeldige feil og antatt effekt dette har på validitet for hele registeret. Angi graden av kompletthet for sentrale variabler}
...
registeret). Beskriv hvordan registeret bidrar til
