...
\chapter{Sammendrag}
\guide{Kortfattet sammendrag av det viktigste i årsrapporten.}
...
individer/hendelser. Kan også brytes opp i antall per år.}
...
for ytterligere beskrivelse. I den grad registeret har etablert (nasjonale)
...
\section{Resultater til deltagende fagmiljø}\label{sec:resfag}
...
bosted) og viktige funn i forhold til registerets kvalitetsmål.}

\section{Sosiale ulikheter}\label{sec:sosuli}
\guide{Beskriv hvilke målinger som benyttes (sivilstatus, utdanning, inntekt,
etnisitet) og viktige funn i forhold til registerets kvalitetsmål.}
