...
data. Beskriv metoden for valideringsarbeidet, eksempelvis:
\begin{itemize}
  ...
  \item tidsrom som dekkes av de data som benyttes i arbeidet,
  \item hvor stor andel av hendelser eller pasienter som ble benyttet i
    arbeidet, og
  \item andre hensyn som er tatt under valideringsarbeidet.
\end{itemize}} 
